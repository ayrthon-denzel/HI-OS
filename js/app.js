...
{section:'Commercial',key:'hunter',icon:'◎',name:'Contract Hunter',perm:'A2',desc:'Recherche, qualification et préparation des approches commerciales.',tools:['Veille','Scoring','CRM','Gmail']},
{section:'Commercial',key:'crm',icon:'▦',name:'CRM & Sales',perm:'A2',desc:'Pipeline, relances, suivi des opportunités et prochaines actions.',tools:['Pipeline','Relances','Gmail','Calendar']},
{section:'Création',key:'designer',icon:'✦',name:'Master Designer',perm:'A2',desc:'Direction artistique, campagnes, visuels et déclinaisons de marque.',tools:['Brand kit','Social','Création','QA']},
{section:'Création',key:'social',icon:'◌',name:'Social Media',perm:'A2',desc:'Planification, programmation et suivi éditorial multicanal.',tools:['LinkedIn','Instagram','Facebook','Analytics']},
{section:'Production',key:'web',icon:'⌘',name:'Web & Software',perm:'A2',desc:'Sites, applications, CRM, automatisations, QA et déploiements.',tools:['GitHub','Render','QA','Database']},
{section:'Opérations',key:'inbox',icon:'✉',name:'Inbox Agent',perm:'A2',desc:'Triage, détection des priorités et préparation des réponses.',tools:['Gmail','Rules','CRM','Audit']},
{section:'Opérations',key:'proposal',icon:'▤',name:'Proposals & Devis',perm:'A1',desc:'Propositions, devis, plaquettes et documents commerciaux.',tools:['Templates','Tarifs','PDF','Portfolio']},
{section:'Système',key:'automation',icon:'⚙',name:'Automation Center',perm:'A2',desc:'Workflows, déclencheurs, tâches planifiées et supervision.',tools:['Cron','Queue','Webhooks','Audit']},
{section:'Système',key:'analytics',icon:'⌁',name:'Analytics',perm:'A0',desc:'Lecture consolidée des performances et signaux de décision.',tools:['Sales','Social','Web','Finance']},
{section:'Système',key:'knowledge',icon:'◇',name:'Knowledge Base',perm:'A1',desc:'Référentiel officiel des offres, règles, tarifs et procédures.',tools:['Docs','Policies','Brand','Knowledge']}
];
